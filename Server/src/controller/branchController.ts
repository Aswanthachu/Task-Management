...
class BranchController extends Controller {
  ...
  public async getAllBranches(
    ...
    try {
      ...
      const [branches, error, httpStatus] = await branchRepo.getAllBranches(
        countryCode
      );
      ...
      await redisHandler.set(
        ...
        (process.env.REDIS_EXPIRY || 5) as number
      );
      this.setStatus(httpStatus);
  ...
  public async getAllAdminView(
    ...
    try {
      await validate(
        validationSchema.adminViewQuerySchema as JSONSchemaType<any>
      );
  ...
  public async getStateByCountry(
    ...
    try {
      ...
      const [branch, error, httpStatus] = await branchRepo.getStateByCountry(
        countryCode
      );
  ...
  public async updateBranchById(
    ...
    try {
      await validate(validationSchema.updateByIdSchema as JSONSchemaType<any>);
